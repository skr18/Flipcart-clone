...

            {
                account.view ==='login' ?
                    <Wrapper>
                        ...
                        <Typography style={{fontSize:14}}>By continuing, you agree to Flipkart's Terms of Use and Privacy Policy.</Typography>
                        ...
                        <Typography style={{color:"#2874f0", cursor:"pointer", textAlign:"center",marginTop:15}}
                                    onClick={()=> tooglesignup()}>New to Flipkart? Create an account</Typography>
                    </Wrapper>
                :
